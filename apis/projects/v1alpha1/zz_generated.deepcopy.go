...
func (in *VariableParameters) DeepCopyInto(out *VariableParameters) {
	*out = *in
	...
	if in.SecretValueRef != nil {
		...
		*out = new(VariableSecretReference)
		(*in).DeepCopyInto(*out)
	}
	if in.Masked != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *VariableSecretReference) DeepCopyInto(out *VariableSecretReference) {
	*out = *in
	if in.Key != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new VariableSecretReference.
func (in *VariableSecretReference) DeepCopy() *VariableSecretReference {
	if in == nil {
		return nil
	}
	out := new(VariableSecretReference)
